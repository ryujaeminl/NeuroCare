 ...
 * CLOVA(비스트리밍, 문장당 ~1~2초)를 쓰는 한 전체 응답 지연의 실질적 하한은 STT+LLM
 * 첫 문장+CLOVA 합성 시간이 결정하므로, 이 대기시간을 더 줄여도 체감 차이는 크지 않다 -
 * 그래도 안전하게 줄일 수 있는 만큼만(350ms) 줄인다. */
export const COMPLETE_SILENCE_MS = 350;
